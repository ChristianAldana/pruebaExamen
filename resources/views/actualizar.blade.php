    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('personas.update', $personas->id) }}" method="POST">
                ...
                <input type="text" name="carnet" class="form-control" required value="{{$personas->carnet}}">
                <label for="">Nombre</label>
                <input type="text" name="nombre" class="form-control" required value="{{$personas->nombre}}">
                <label for="">Nota</label>
                <input type="text" name="nota" class="form-control" required value="{{$personas->nota}}">
